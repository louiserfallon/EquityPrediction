...
for (i in 1:ncol(lag.0)) colnames(lag.0)[i] <- gsub(" ","",colnames(lag.0)[i])
lag.1 <- returns[3:(nrow(returns)-1),2:ncol(returns)]
for (i in 1:ncol(lag.1)) colnames(lag.1)[i] <- gsub(" ","", paste(colnames(lag.1)[i],"_lag_1",sep="")) 
lag.2 <- returns[2:(nrow(returns)-2),2:ncol(returns)]
for (i in 1:ncol(lag.2)) colnames(lag.2)[i] <- gsub(" ","", paste(colnames(lag.2)[i],"_lag_2",sep=""))
lag.3 <- returns[1:(nrow(returns)-3),2:ncol(returns)]
for (i in 1:ncol(lag.3)) colnames(lag.3)[i] <- gsub(" ","", paste(colnames(lag.3)[i],"_lag_3",sep=""))
